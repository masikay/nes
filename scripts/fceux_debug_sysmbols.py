...
if __name__ == "__main__":
    ...
    base_out_file = label_file.split(".")[0]
    label_to_nl(sys.argv[1], base_out_file + ".nes.ram.nl", 0x0000, 0x7FF)
    label_to_nl(sys.argv[1], base_out_file + ".nes.0.nl", 0x8000, 0xBFFF)
    label_to_nl(sys.argv[1], base_out_file + ".nes.1.nl", 0xC000, 0xFFFF)
