...
LoopSprites:
	...
	sta $0200,x				; Store the bytes starting at OAM address $0200
 	inx						; X++
	cpx #16
	bne LoopSprites			; Loop 16 times (4 hardware sprites, 4 bytes each)
	rts						; Return from subroutine
.endproc
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
SpriteData:
.byte $10, $3A, %00000000, $10	; OAM sprite 0 at (x: 16, y: 16)
.byte $10, $37, %00000000, $18	; OAM sprite 1 at (x: 24, y: 16)
.byte $18, $4F, %00000000, $10	; OAM sprite 2 at (x: 16, y: 24)
.byte $18, $4F, %01000000, $18	; OAM sprite 3 at (x: 24, y: 24) --> flip-horz
