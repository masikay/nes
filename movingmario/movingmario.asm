...
InitVarables:
	...
	ldx #0
	lda SpriteData,x
	sta YPos				; Store byte 0 of SpriteData (YPos)
	inx
	inx
	inx
	lda SpriteData,x
	sta XPos				; Store byte 3 of SpriteData (XPos)
...
; Mario
;      Y  tile# attributes	X
.byte $AE, $3A, %00000000, $98	; OAM sprite 0 at (x: 16, y: 16)
.byte $AE, $37, %00000000, $A0	; OAM sprite 1 at (x: 24, y: 16)
